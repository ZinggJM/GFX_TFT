...
GFX_OTM8009A::GFX_OTM8009A(int16_t cs_pin, int16_t dc_pin, int16_t rst_pin, int16_t bl_pin) :
#if defined(ESP8266)
...
GFX_OTM8009A::GFX_OTM8009A(int16_t cs_pin, int16_t dc_pin, int16_t mosi_pin, int16_t sclk_pin, int16_t rst_pin, int16_t bl_pin) :
...
GFX_OTM8009A::GFX_OTM8009A(SPIClass *spi, int16_t cs_pin, int16_t dc_pin, int16_t rst_pin, int16_t bl_pin) :
#if defined(ESP8266)
  GFX_TFT_IO(480, 800, cs_pin, dc_pin, rst_pin)
#else
  GFX_TFT_IO(480, 800, spi, cs_pin, dc_pin, rst_pin)
