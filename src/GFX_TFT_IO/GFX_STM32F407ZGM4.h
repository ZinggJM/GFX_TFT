// created by Jean-Marc Zingg to be the GFX_STM32F407ZGM4 io class for the GFX_TFT library
//
...
#ifndef _GFX_STM32F407ZGM4_H_
#define _GFX_STM32F407ZGM4_H_
...
class GFX_STM32F407ZGM4 : public GFX_TFT_IO_Plugin
{
  public:
    GFX_STM32F407ZGM4(bool bl_active_high = true);
    const char* name = "GFX_STM32F407ZGM4";
    void reset();
    void init();
    uint8_t readData();
    uint16_t readData16();
...
#define GFX_TFT_IO_PLUGIN_CLASS GFX_STM32F407ZGM4
