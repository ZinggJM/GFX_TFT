...
#ifndef _GFX_STM32F103C_TIKY_H_
#define _GFX_STM32F103C_TIKY_H_
...
class GFX_STM32F103C_TIKY : public GFX_TFT_IO_Plugin
{
  public:
    GFX_STM32F103C_TIKY(bool bl_active_high = true);
    const char* name = "GFX_STM32F103C_TIKY";
    void reset();
    void init();
    uint8_t readData();
    uint16_t readData16();
...
#define GFX_TFT_IO_PLUGIN_CLASS GFX_STM32F103C_TIKY
