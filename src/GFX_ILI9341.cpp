...
GFX_ILI9341::GFX_ILI9341(int16_t cs_pin, int16_t dc_pin, int16_t rst_pin, int16_t bl_pin) :
#if defined(ESP8266)
...
GFX_ILI9341::GFX_ILI9341(int16_t cs_pin, int16_t dc_pin, int16_t mosi_pin, int16_t sclk_pin, int16_t rst_pin, int16_t bl_pin) :
...
GFX_ILI9341::GFX_ILI9341(SPIClass *spi, int16_t cs_pin, int16_t dc_pin, int16_t rst_pin, int16_t bl_pin) :
#if defined(ESP8266)
  GFX_TFT_IO(240, 320, cs_pin, dc_pin, rst_pin)
#else
  GFX_TFT_IO(240, 320, spi, cs_pin, dc_pin, rst_pin)
